...
from idecutils import AttentionLayer
...
class AE_3views(nn.Module):
    ...
    def __init__(self, n_stacks, n_input, n_z):
        ...
        self.mu0 = Linear(dims0[2], n_z)
        self.log_var0 = Linear(dims0[2], n_z)
        # encoder1
        ...
        self.mu1 = Linear(dims1[2], n_z)
        self.log_var1 = Linear(dims1[2], n_z)
        # encoder2
        ...
        self.mu2 = Linear(dims2[2], n_z)
        self.log_var2 = Linear(dims2[2], n_z)
    ...
    def forward(self, x0, x1, x2):
        ...
        mu0 = self.mu0(enc0_h3)
        log_var0 = self.log_var0(enc0_h3)
        sampled_z0 = self.reparameterization(mu0, log_var0)
        # encoder1
        ...
        mu1 = self.mu1(enc1_h3)
        log_var1 = self.log_var1(enc1_h3)
        sampled_z1 = self.reparameterization(mu1, log_var1)
        # encoder2
        ...
        mu2 = self.mu2(enc2_h3)
        log_var2 = self.log_var2(enc2_h3)
        ...
        # add directly
        #z = (z0 + z1 + z2) / 3
        z = self.fusion(sampled_z0, sampled_z1, sampled_z2)
        # decoder0
        ...
        #x0_bar = torch.sigmoid(self.x0_bar_layer(dec0_h3))
        # decoder1
        ...
        #x1_bar = torch.sigmoid(self.x1_bar_layer(dec1_h3))
        # decoder2
        ...
        #x2_bar = torch.sigmoid(self.x2_bar_layer(dec2_h3))

        return x0_bar, x1_bar, x2_bar, z, sampled_z0, sampled_z1, sampled_z2, mu0, log_var0, mu1, log_var1, mu2, log_var2
